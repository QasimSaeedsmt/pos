...
//       //   actions: [
//       //     // Use IconButton + Switch approach
//       //     Padding(
//       //       padding: const EdgeInsets.symmetric(horizontal: 8.0),
//       //       child: GestureDetector(
//       //         onTap: () async {
//       //           // Toggle fingerprint
//       //           final newValue = !authProvider.fingerprintEnabled;
//       //
//       //           if (newValue) {
//       //             // Ensure we run after build so context is valid
...
//       //             });
//       //           } else {
//       //             await authProvider.setFingerprintEnabled(false);
//       //           }
//       //         },
//       //         child: Row(
//       //           children: [
...
//       //               onChanged: (_) async {
//       //                 // Delegate tap handling to GestureDetector
//       //               },
//       //             ),
//       //           ],
//       //         ),
...
//                               // In LoginScreen build method, after _buildKeepMeLoggedInCheckbox
//                               Align(
...
//     // Don't call notifyListeners() to avoid UI rebuild
//   }
...
//     final prefs = await SharedPreferences.getInstance();
//     setState(() {
//       _isChecked = prefs.getBool('keepMeLoggedIn') ?? false;
//     });
//   }
//
...
//     });
//
//     // Update shared preferences directly
//     final prefs = await SharedPreferences.getInstance();
//     await prefs.setBool('keepMeLoggedIn', value);
//
//     // Optional: Update provider without triggering rebuild
//     final authProvider = Provider.of<MyAuthProvider>(context, listen: false);
//     authProvider.setKeepMeLoggedInSilent(value);
//   }
//
//   @override
//   Widget build(BuildContext context) {
