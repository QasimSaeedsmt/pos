      ...
      child: _isLoading
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: _isFormValid
              ...
              : Theme.of(context).colorScheme.onSurface.withOpacityFactor(0.12),
          foregroundColor: _isFormValid
              ? Colors.white
              : Theme.of(context).colorScheme.onSurface.withOpacityFactor(0.38),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
          ),
          elevation: 2,
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Theme.of(
                          context,
                        ).colorScheme.onSurface.withOpacityFactor(0.6),
                      ),
                    ),
                  ],
                ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          StreamBuilder<bool>(
            stream: posService.onlineStatusStream,
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 80,
              color: Theme.of(context).colorScheme.onSurface.withOpacityFactor(0.3),
            ),
            const SizedBox(height: 16),
            Text(
              _showSearchResults
              ...
              style: TextStyle(
                fontSize: 18,
                color: Theme.of(context).colorScheme.onSurface.withOpacityFactor(0.6),
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                color: Theme.of(context).colorScheme.onSurface.withOpacityFactor(0.4),
              ),
            ),
        ...
        return Card(
          ...
          child: ListTile(
            leading: Container(
              ...
              height: 44,
              decoration: BoxDecoration(
                color: Theme.of(context).colorScheme.primary.withOpacityFactor(0.1),
                shape: BoxShape.circle,
              ),
              child: Icon(
                Icons.person,
